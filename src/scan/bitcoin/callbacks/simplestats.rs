use crate::scan::bitcoin::blockchain::proto::block::{self, Block};
use crate::scan::bitcoin::blockchain::proto::script::ScriptPattern;
use crate::scan::bitcoin::blockchain::proto::ToRaw;
use crate::scan::bitcoin::callbacks::Callback;
use crate::scan::bitcoin::common::utils;
use crate::scan::bitcoin::errors::OpResult;
